...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">eCommerce /</span>sub Occution List
        </h4>
        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="row my-4">
                    <div class="col-md-12 float-right text-right" style="text-align: right">
                        <button   onclick="showModalForm()" class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                            ...
                            <span><i class="bx bx-plus me-0 me-sm-1"></i>Add sub Occution</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-datatable table-responsive">
                    <table class="datatables-table table border-top">
                        ...
                        <tbody>
                            @foreach ($suboccution as $key=> $item)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$item->title}}</td>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="categoryAddModal"
                ...
                <div class="offcanvas-header py-4">
                    <h5 id="categoryAddModalLabel" class="offcanvas-title">Add sub Occution</h5>
...
@section('js')
    ...
    <script>
        function showModalForm() {
            $.ajax({
                url: "{{URL::to('admin/product/add_suboccution_form_html')}}", // Replace with your listing URL
                type: 'GET',
                data:{form_id:''},
        ...
        function submit_form() {
            ...
            $.ajax({
                url: "{{ URL::to('admin/product/add_suboccution') }}", // Replace with your submit URL
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        function editForm(form_id) {
            $.ajax({
                url: "{{URL::to('admin/product/edit_suboccution')}}", // Replace with your listing URL
                type: 'GET',
