...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">eCommerce /</span> Product Type List
        </h4>
        ...
        <div class="app-ecommerce-category">
                ...
                <div class="row my-4">
                    <div class="col-md-12 float-right text-right" style="text-align: right">
                        <button   onclick="showModalForm()" class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                            ...
                            <span><i class="bx bx-plus me-0 me-sm-1"></i>Add Product Type</span>
                        </button>
                    </div>
                </div>
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown pe-3">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                <a class="dropdown-item" href="{{ URL::to('admin/product/delete_product_type', $item->id) }}" onclick="deleteConfirmationGet(event)">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="categoryAddModal"
                ...
                <div class="offcanvas-header py-4">
                    <h5 id="categoryAddModalLabel" class="offcanvas-title">Add Product Type</h5>
...
@section('js')
    ...
    <script>
        function showModalForm() {
            $.ajax({
                url: "{{URL::to('admin/product/add_product_type_form_html')}}", // Replace with your listing URL
                type: 'GET',
                data:{form_id:''},
        ...
        function submit_form() {
            ...
            $.ajax({
                url: "{{ URL::to('admin/product/add_product_type') }}", // Replace with your submit URL
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        function editForm(form_id) {
            $.ajax({
                url: "{{URL::to('admin/product/edit_product_type')}}", // Replace with your listing URL
                type: 'GET',
