        ...
        <div class="app-ecommerce-category">
                ...
                <div class="row my-4">
                    <div class="col-md-12 float-right text-right" style="text-align: right">
                        <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                            ...
                            <span><i class="bx bx-plus me-0 me-sm-1"></i>Add Exhibition User</span>
                        </button>
                    </div>
                </div>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEcommerceCategoryList"
                ...
                <div class="offcanvas-header py-4">
                    <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">Add Exhibition User</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        ...
                        <!-- Slug -->
                        <div class="mb-3">
                            <label class="form-label" for="ecommerce-category-slug">Phone</label>
                            <input type="text" id="ecommerce-category-slug" class="form-control" placeholder="Enter slug"
                                aria-label="slug" name="slug">
                        </div>
                        <!-- Image -->
                        <div class="mb-3">
                            <label class="form-label" for="ecommerce-category-image">Id</label>
                            <input class="form-control" type="text" id="ecommerce-category-image">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="ecommerce-category-image">Username</label>
                            <input class="form-control" type="text" id="ecommerce-category-image">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="ecommerce-category-image">Select </label>
                            <select name=""class="form-control" id="">
                                <option value="" >Exhibition1</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="ecommerce-category-image">Password</label>
                            <input class="form-control" type="date" id="ecommerce-category-image">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="ecommerce-category-image">Status </label>
                            <select name=""class="form-control" id="">
